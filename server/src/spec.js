...
describe('Route API', () => {
  ...
  describe('/ (POST)', () => {
    ['route', 'httpMethod', 'statusCode', 'delay', 'payload'].forEach(
      (requiredProperty) => {
  ...
  describe('/ (PUT)', () => {
    ['route', 'httpMethod', 'statusCode', 'delay', 'payload', 'id'].forEach(
      (requiredProperty) => {
        it(`returns a 400 status code when ${requiredProperty} property is missing from the payload`, async () => {
    ...
    it('returns a 200 and updates the given route to the configuration file with a generated ID', async () => {
      ...
      await writeConfiguration({
        routes: [generateRoute(), generateRoute(), originalRoute]
      });
  ...
  describe('/ (DELETE)', () => {
    ...
    it('returns a 200 and deletes the given route', async () => {
      ...
      await writeConfiguration({
        routes: [generateRoute(), generateRoute(), route]
      });
